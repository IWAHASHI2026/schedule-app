...
{{
  ...
  "employee_name": "スタッフ名",
  "date": "YYYY-MM-DD",
  "new_job_type": "職人" / "サブ職人" / "lkデータ" / "uv/cpデータ" / "手紙" / "その他" / "休み"
}}
...
{{
  "type": "adjust",
  "employee_name": "スタッフ名",
  "job_type": "職人" / "サブ職人" / "lkデータ" / "uv/cpデータ" / "手紙" / "その他",
...
- 「サブ」→「サブ職人」、「lkデータ」→「lkデータ」、「uvデータ」「uvcデータ」「uvcpデータ」→「uv/cpデータ」、「手紙」→「手紙」、「職人」→「職人」のように正式名称にしてください
